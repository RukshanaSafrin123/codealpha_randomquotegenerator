...
const quotes = [
    ...
    { content: "The whole secret of a successful life is to find out what is ones destiny to do, and then do it.", author: "Henry Ford" },
    ...
    { content: "Life is a tragedy that gets old too soon and wise too late.", author: "Benjamin Franklin" },
    ...
    { content: "Keep smiling, because life is a beautiful thing and there is so much to smile about.", author: "Marilyn Monroe" },
    ...
    { content: "Your time is limited, so do not waste it living someone else life.", author: "Steve Jobs" },
    ...
    { content: "Life shrinks or expands in proportion to ones courage.", author: "Anaïs Nin" },
    { content: "Life is a play. It is not its length, but its performance that counts.", author: "Seneca" },
...
function getQuote() {
    ...
    setTimeout(() => {
        quoteE1.innerText = selectedQuote.content;
        authorE1.innerText = `~ ${selectedQuote.author}`;
